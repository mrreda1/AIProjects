...
def select_parents(population: Population,
                   fitness_func: FitnessFunc) -> List[Genome]:
...
def make_generation(population: Population,
                    fitness_func: FitnessFunc) -> Population:
    ...
    for _ in range(400):
        parents = select_parents(
            population=population, fitness_func=fitness_func)
...
def main():
    ...
    for i in range(10000):
        ...
        population = make_generation(
            population=population, fitness_func=fitness)
